...
def __dessine_axes(can, can_height, can_width, bord, xmin, xmax, ymin, ymax):
    ...
    can.create_line(pos_x0, pos_ymin, pos_x0, pos_ymax)
    can.create_line(pos_x0-5, pos_ymax+10, pos_x0, pos_ymax)
    can.create_line(pos_x0+5, pos_ymax+10, pos_x0, pos_ymax)
    can.create_text(pos_x0-1, pos_ymin, text=str(ymin), anchor=W)
    can.create_text(pos_x0-1, pos_ymax,text=str(ymax), anchor=W)
...
def dessine_lignes_brisees( courbe_rouge = [], courbe_bleue = [], courbe_verte = [],
    ...
    """
    La fonction dessine_courbes_brisees dessine sur un Canvas de taille height par width.
